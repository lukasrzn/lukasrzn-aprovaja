...
const SECTIONS = [
  ...
  },
  {
    ...
    list: [
      "Plano Pro (R$ 34,90/mês): acesso a simulados ilimitados, flashcards, plano de estudos com IA, gamificação completa e 2 correções de redação por mês.",
      "Plano Vitalício (R$ 95,90, pagamento único): inclui todos os recursos do Pro, além de redações ilimitadas, Professor IA 24/7, simulados inéditos semanais e métricas avançadas. Acesso vitalício à plataforma sem cobranças recorrentes.",
      "Pagamentos são processados através de gateway certificado. O AprovaJá não armazena dados de cartão de crédito.",
      "O plano Pro é renovado automaticamente ao final de cada ciclo mensal, salvo cancelamento expresso pelo usuário antes da data de renovação. O plano Vitalício é cobrado uma única vez.",
